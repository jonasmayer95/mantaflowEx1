extern "C" {
		...
		extern void PbRegister_levelsetToDensity() ;
		extern void PbRegister_solvePressureGS() ;
		extern void PbRegister_getMaxDivergence() ;
		extern void PbRegister_diffuseTemperatureExplicit() ;
		extern void PbRegister_diffuseTemperatureImplicit() ;
...
namespace Pb {
	void MantaEnsureRegistration()
	{
		...
		PbRegister_levelsetToDensity() ;
		PbRegister_solvePressureGS() ;
		PbRegister_getMaxDivergence() ;
		PbRegister_diffuseTemperatureExplicit() ;
		PbRegister_diffuseTemperatureImplicit() ;
		PbRegister_file_0();
		PbRegister_file_1();
		PbRegister_file_2();
		PbRegister_file_3();
