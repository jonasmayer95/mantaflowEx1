...
KERNEL(bnd = 1)
void computeDiffuseTemperatureExplicit(FlagGrid& flags, Grid<Real>& T0, Real alpha){
...
PYTHON() void diffuseTemperatureImplicit(FlagGrid& flags, Grid<Real>& T0, Real alpha){
	// solve A T = b
