...
W_2    = weight_variable([n_code, n_code])
b_2    = bias_variable([n_code])

z2      = tf.nn.tanh(tf.matmul(z, W_2) + b_2) # hidden layer

W_3    = weight_variable([n_code, n_output])
b_3    = bias_variable([n_output])

y_pred = tf.nn.tanh(tf.matmul(z2, W_3) + b_3)
